...
function App() {
  ...
  const [tradeAsset, setTradeAsset] = useState("ethereum");
  ...
  const addPartyChain = async () => {
    ...
    try {
      ...
      await window.keplr.experimentalSuggestChain({
        ...
        bech32Config: {
          bech32PrefixAccAddr: "party",
          bech32PrefixAccPub: "party" + "pub",
          bech32PrefixValAddr: "party" + "valoper",
          bech32PrefixValPub: "party" + "valoperpub",
          bech32PrefixConsAddr: "party" + "valcons",
          bech32PrefixConsPub: "party" + "valconspub",
        },
        currencies: [
          {
            coinDenom: "GRM",
      ...
      // If the extension already has partychain info, same result will be shown.
      // alert("success");
      console.log("succesfully added partychain to keplr extension");


    } catch (error) {
      // In case, reject to add partychain info to the extension
      alert("error : " + error);
    }
